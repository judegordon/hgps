...
hgps::Person create_test_entity(hgps::core::Gender gender = hgps::core::Gender::male, int age = 20,
                                double bmi = 23.5) {
...
TEST_F(WeightModelTest, ClassifyAdultWeight) {
    ...
    auto expected = std::array<WeightCategory, 8>{
        WeightCategory::normal, WeightCategory::normal,     WeightCategory::normal,
        WeightCategory::normal, WeightCategory::overweight, WeightCategory::overweight,
