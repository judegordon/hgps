...
TEST(TestHealthGPS_LifeTable, CreateFull) {
    ...
    deaths.emplace(
        2020, std::map<int, Mortality>{{1, Mortality(5.0f, 6.0f)}, {2, Mortality(5.5f, 6.5f)}});

    deaths.emplace(
        2021, std::map<int, Mortality>{{1, Mortality(6.0f, 6.5f)}, {2, Mortality(7.0f, 7.3f)}});

    deaths.emplace(
        2022, std::map<int, Mortality>{{1, Mortality(7.0f, 7.3f)}, {2, Mortality(7.5f, 8.1f)}});
...
TEST(TestHealthGPS_LifeTable, CreateEmptyDeathsMismatchThrow) {
    using namespace hgps;
    auto births = std::map<int, Birth>{{2021, Birth(10.0f, 0.9f)}};
